...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_DOSTAWCY NOLOGGING;
...
-- INDEXy
------------------------	
	CREATE INDEX bd1_IX_DO_NAZWA_FIRMY 
	ON bd1_DOSTAWCY (DO_NAZWA_FIRMY)
	TABLESPACE STUDENT_INDEX NOLOGGING;

	CREATE INDEX bd1_IX_DO_NIP 
	ON bd1_DOSTAWCY (DO_NIP)
	TABLESPACE STUDENT_INDEX NOLOGGING;	
	
	CREATE INDEX bd1_IX_DO_KONTAKT
	ON bd1_DOSTAWCY (DO_KONTAKT)
	TABLESPACE STUDENT_INDEX NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_SZTYCE NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_SIODELKA NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_LANCUCHY NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_ZEBATKI NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_KASETY NOLOGGING;
...
-- INDEXy
------------------------	
	CREATE INDEX bd1_IX_KA_NAZWA
	ON bd1_KASETY (KA_NAZWA)
	TABLESPACE STUDENT_INDEX NOLOGGING;

	CREATE INDEX bd1_IX_KA_MAX_VALUE
	ON bd1_KASETY (KA_MAX_VALUE)
	TABLESPACE STUDENT_INDEX NOLOGGING;	
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_MANETKI NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_OPONY NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_OBRECZE NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_KIEROWNICE NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_AMORTYZATORY NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_RAMY NOLOGGING;
...
-- NOLOGGING
------------------------
	ALTER TABLE bd1_ROWERY NOLOGGING;
...
-------------------------------- ---------- -------------------- ------------------------------------------- --------------------------------------------
PK_BD1_RAMY                      NORMAL     BD1_RAMY             1[%]                                        64[kB]
PK_BD1_SZTYCY                    NORMAL     BD1_SZTYCE           1[%]                                        64[kB]
BD1_IX_DO_NAZWA_FIRMY            NORMAL     BD1_DOSTAWCY         10[%]                                       64[kB]
PK_BD1_MANETKI                   NORMAL     BD1_MANETKI          1[%]                                        64[kB]
PK_BD1_KIEROWNICE                NORMAL     BD1_KIEROWNICE       1[%]                                        64[kB]
BD1_IX_DO_KONTAKT                NORMAL     BD1_DOSTAWCY         10[%]                                       64[kB]
PK_BD1_SIODELKA                  NORMAL     BD1_SIODELKA         1[%]                                        64[kB]
PK_BD1_LANCUCHY                  NORMAL     BD1_LANCUCHY         1[%]                                        64[kB]
PK_BD1_DOSTAWCY                  NORMAL     BD1_DOSTAWCY         1[%]                                        64[kB]
PK_BD1_ZEBATKI                   NORMAL     BD1_ZEBATKI          1[%]                                        64[kB]
PK_BD1_AMORTYZATORY              NORMAL     BD1_AMORTYZATORY     1[%]                                        64[kB]
PK_BD1_OPONY                     NORMAL     BD1_OPONY            1[%]                                        64[kB]
PK_BD1_ROWERY                    NORMAL     BD1_ROWERY           1[%]                                        64[kB]
BD1_IX_DO_NIP                    NORMAL     BD1_DOSTAWCY         10[%]                                       64[kB]
PK_BD1_KASETY                    NORMAL     BD1_KASETY           1[%]                                        64[kB]
PK_BD1_OBRECZE                   NORMAL     BD1_OBRECZE          1[%]                                        64[kB]
*/

	
PROMPT ---------------------------------------------	
PROMPT -- Transaction Control System
PROMPT ---------------------------------------------
...
Commit; 
	...
	select ROWID, DO_ID_DOSTAWCY, DO_NAZWA_FIRMY, DO_NIP, DO_KONTAKT
	from bd1_DOSTAWCY;

/*
	ROWID                   ID DO_NAZWA_FIRMY                 NIP           NUMER TEL.
	------------------ ------- ------------------------------ ------------- ------------------------------
	AALrHtABiAAAAj/AAA       1 SPECJALIZED                    106-00-00-062 specjalized.contact@gmail.com
	AALrHtABiAAAAj/AAB       2 NSBIKES                        107-00-11-034 NSBIKES.contact@gmail.com
	AALrHtABiAAAAj/AAC       3 KONA                           190-34-22-035 KONA.contact@gmail.com
	AALrHtABiAAAAj/AAD       4 Kross                          190-34-22-035
*/
...
------------------------
	insert into bd1_DOSTAWCY(DO_NAZWA_FIRMY,DO_NIP,DO_KONTAKT)
	values ('Orange','121-01-22-661','orange.contact@gmail.com');


	update bd1_DOSTAWCY set DO_NAZWA_FIRMY = 'Orange SA' where DO_ID_DOSTAWCY = 5;
...
AALrHtABiAAAAj/AAC       3 KONA                           190-34-22-035 KONA.contact@gmail.com
AALrHtABiAAAAj/AAD       4 Kross                          190-34-22-035
AALrHtABiAAAAj/AAE       5 Orange SA                      121-01-22-661 orange.contact@gmail.com
*/
rollback;	
...
update bd1_DOSTAWCY set DO_NAZWA_FIRMY = 'Orange SA' where DO_ID_DOSTAWCY = 6;
...
AALrHtABiAAAAj/AAC       3 KONA                           190-34-22-035 KONA.contact@gmail.com
AALrHtABiAAAAj/AAD       4 Kross                          190-34-22-035
AALrHtABiAAAAj/AAE       6 Orange SA                      121-01-22-661 orange.contact@gmail.com
	*/
	
 ROLLBACK TO SAVEPOINT ORANGE;
...
AALrHtABiAAAAj/AAC       3 KONA                           190-34-22-035 KONA.contact@gmail.com
AALrHtABiAAAAj/AAD       4 Kross                          190-34-22-035
AALrHtABiAAAAj/AAE       6 Orange                         121-01-22-661 orange.contact@gmail.com
*/

commit;
delete from bd1_DOSTAWCY where DO_ID_DOSTAWCY=6;
/*
ROWID                   ID DO_NAZWA_FIRMY                 NIP           NUMER TEL.
------------------ ------- ------------------------------ ------------- ------------------------------
AALrHtABiAAAAj/AAA       1 SPECJALIZED                    106-00-00-062 specjalized.contact@gmail.com
